 ...
 */
function transformToBusiness(scraped: RawScraperResult, ownerId: string): Omit<Business, "createdAt" | "updatedAt"> {
...
export async function importBusinessBatch(
  client: PoolClient,
  scrapedResults: RawScraperResult[],
  ownerId: string,
  batchSize: number = 50
