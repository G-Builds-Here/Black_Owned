...
describe("Businesses API", () => {
  ...
  describe("GET /api/businesses", () => {
    ...
    it("should filter by source", async () => {
      const mockRequest = {
        url: "http://localhost:3000/api/businesses?source=google-maps",
      } as unknown as NextRequest;
      ...
      expect(findBusinessesWithFilter).toHaveBeenCalledWith(
        expect.any(Object),
        expect.objectContaining({ source: "google-maps" })
      );
    });

    it("should filter by yelp source", async () => {
      const mockRequest = {
        url: "http://localhost:3000/api/businesses?source=yelp",
      } as unknown as NextRequest;
      ...
      expect(findBusinessesWithFilter).toHaveBeenCalledWith(
        expect.any(Object),
        expect.objectContaining({ source: "yelp" })
      );
    });

    it("should filter by facebook source", async () => {
      const mockRequest = {
        url: "http://localhost:3000/api/businesses?source=facebook",
      } as unknown as NextRequest;
    ...
    it("should combine all filters", async () => {
      const mockRequest = {
        url: "http://localhost:3000/api/businesses?search=restaurant&status=approved&source=google-maps&page=1&limit=10",
      } as unknown as NextRequest;
    ...
    it("should reject invalid source", async () => {
      const mockRequest = {
        url: "http://localhost:3000/api/businesses?source=invalid",
      } as unknown as NextRequest;
